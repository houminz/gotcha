...
import (
	...
	versioned "github.com/SimpCosm/crddemo/pkg/client/clientset/versioned"
	internalinterfaces "github.com/SimpCosm/crddemo/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/SimpCosm/crddemo/pkg/client/listers/example/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&examplev1.Foo{},
		resyncPeriod,
